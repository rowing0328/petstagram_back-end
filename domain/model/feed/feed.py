...
from domain.model.feed.feed_type import FeedType
...
class Feed(SQLModel, table=True):
    ...
    @classmethod
    def create(cls, member_id: int, subject: str, feed_type: str, images: List[str], content: str):
        return cls(
            member_id=member_id,
            subject=subject,
    ...
    def change(self, subject: str, feed_type: str, images: List[str], content: str):
